...
<head>
    <meta charset="utf-8">
    <title>Resumen de Citas de Hoy</title>
    <style>
...
<body>
    <div class="container">
        ...
        <div class="content">
            <p class="welcome-text">¡Hola, {{ $admin->name }}!</p>
            <p>Este es el reporte automatizado general de las citas programadas para el día de hoy en todo el establecimiento.</p>
            
            <div class="summary-box">
                @php
                    $totalCitas = 0;
                    foreach ($appointmentsGrouped as $barberAppts) {
                        $totalCitas += $barberAppts->count();
                    }
                @endphp
                <strong>Total de citas globales para hoy:</strong> {{ $totalCitas }}
            </div>

            <p style="text-align: center; font-size: 14px; color: #6b7280; font-style: italic;">
                Se ha adjuntado un documento PDF con el desglose detallado de citas por barbero.
            </p>
        </div>
        <div class="footer">
            <p>Reporte Administrativo Automatizado</p>
